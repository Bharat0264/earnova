...
const caTaxJobSchema = new mongoose.Schema({
  ...
  servicePackage: {
    ...
    default: 'simple-salaried',
  },
  serviceLabel: { type: String, trim: true, default: 'Simple salaried' },
  serviceAmount: { type: Number, min: 0, default: 1250 },
  serviceAmountMax: { type: Number, min: 0, default: 1250 },
  earnovaFee: { type: Number, min: 0, default: 49 },
  caPayoutAmount: { type: Number, min: 0, default: 1201 },
  caPayoutAmountMax: { type: Number, min: 0, default: 1201 },
  paymentStatus: {
    type: String,
    enum: ['pending', 'paid', 'admin-waived', 'failed'],
    default: 'pending',
    index: true,
  },
